...
################################################################################
Rscript ./table2itol.R -a -c double -D style1 -i OTUID -l Genus -t %s -w 0.5 ../classification.txt
Rscript table2itol/table2itol.R -a -c factor -D plan4 -i OTUID -l Genus -t %s -w 0 classification.txt
Rscript ./table2itol.R -a -d -c none -D style2 -b Phylum -i OTUID -l Genus -t %s -w
0.5 ./classification2.txt

Rscript ./table2itol.R -a -d -c none -D style2 -b Phylum -i OTUID -l Genus -t %s -w 0.5 ../classification2.txt


Rscript ./table2itol.R -c keep -D style3 -i OTUID -t %s ../otus.txt

Rscript ./table2itol.R -a -c factor -D style4 -i OTUID -l Genus -t %s -w 0 ../classification2.txt
